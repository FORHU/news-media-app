...
const lavagueTechTheme: Theme = {
  ...
  topBar: 'absolute top-0 left-0 w-full h-1 bg-blue-700',
  logo: (
    <div className="text-center mb-10 flex flex-col items-center">
      ...
      <div className="flex items-center gap-3">
        ...
        <p className="text-[10px] font-black tracking-[0.35em] text-gray-400 uppercase">Admin Portal</p>
        <span className="h-px w-8 bg-gray-200" />
      </div>
    </div>
  ),
  accent: '#1d4ed8',
  accentCls: 'bg-blue-700',
  accentHover: 'hover:bg-blue-800',
  inputFocus: 'focus:border-blue-600',
  ...
  backCls: 'fixed top-6 left-6 sm:top-10 sm:left-10 flex items-center gap-3 text-gray-500 hover:text-blue-700 transition-all group z-10 font-black uppercase tracking-[0.25em] text-[10px]',
  ...
  footerCls: 'text-center mt-8 text-gray-400 font-bold text-[10px] uppercase tracking-[0.3em]',
