                    ...
                    >
                      <div className="flex flex-col md:grid md:grid-cols-2 h-full min-h-0">
                        ...
                        <div className="p-4 sm:p-6 md:p-8 flex flex-col justify-center min-h-0 min-w-0 overflow-hidden flex-1">
                          ...
                          <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-black mb-3 sm:mb-4 line-clamp-2 md:line-clamp-3 group-hover:text-[#ff4500] transition-colors">
                            {article.title}
                          </h1>
