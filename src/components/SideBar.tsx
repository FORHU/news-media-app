            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-0 top-0 h-screen w-80 max-w-[85vw] bg-white z-[70] shadow-2xl flex flex-col overflow-hidden"
                    >
                        {/* Header */}
                        <div className="flex-shrink-0 bg-black py-4 px-4 flex items-center justify-between">
                            <button
                                onClick={onClose}
                        ...
                        <div className="flex-shrink-0 bg-white border-t border-gray-100 p-6">
                            ...
                            >
                                ...
                                >
                                    <Mail className="w-6 h-6 text-white group-hover:text-[#ff4500] transition-colors" />
                                </motion.div>
                                <span className="text-base font-bold text-white uppercase tracking-widest">Newsletter</span>
                            </button>
