...
export default function TechOggiFooter({
  domain,
  onOpenNewsletter,
      ...
      >
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-3 text-sm text-white/70">
                ...
                <li><Link href="/search" className="hover:text-white transition-colors">Tutte le notizie</Link></li>
                <li><Link href="/search" className="hover:text-white transition-colors">Archivio</Link></li>
                <li><a href="mailto:socials@forhu.ai" className="hover:text-white transition-colors">Contatti</a></li>
              </ul>
            </div>
            ...
            >
              ...
              <p className="text-sm text-white/70 mb-4 leading-relaxed">
                Le notizie tech della giornata, ogni mattina nella tua casella di posta.
              </p>
              {onOpenNewsletter && (
                <button
                  type="button"
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/50 font-mono">
            <p>© {new Date().getFullYear()} {theme.name}. Tutti i diritti riservati.</p>
            <div className="flex items-center gap-6">
              <Link href="/search" className="hover:text-white transition-colors">Privacy</Link>
              <Link href="/search" className="hover:text-white transition-colors">Termini</Link>
              <Link href="/search" className="hover:text-white transition-colors">Cookie</Link>
            </div>
          </div>
        </div>
      </footer>
