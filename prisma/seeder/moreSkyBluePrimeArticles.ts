...
const newTechArticles = [
  ...
  // Gadgets
  {
    ...
    categoryName: "Consumer Tech & Hardware",
  ...
  // Software
  {
    ...
    categoryName: "Software Development & Open Source",
  ...
  // Cybersecurity
  {
    ...
    categoryName: "Cybersecurity & Digital Privacy",
  ...
  // Startups
  {
    ...
    categoryName: "Startups & Venture Capital",
  ...
  // Cloud Computing
  {
    ...
    categoryName: "Enterprise & Cloud Infrastructure",
  ...
  // Tech Policy
  {
    ...
    categoryName: "Tech Policy, Law, & Regulation",
